...
from CanSatGraph import CanSatGraph
import sys
...
class GraphGrid(QtWidgets.QDialog):
    ...
    def initGrid(self):
        ...
        self.grid = QtWidgets.QVBoxLayout() #QGridLayout()
        self.grid.setSpacing(10)

        self.alti_graph = CanSatGraph("ALTITUDE")
        self.pressure = CanSatGraph("PRESSURE")
        self.temp = CanSatGraph("TEMP")
        self.voltage = CanSatGraph("VOLTAGE")
        self.air_speed = CanSatGraph("AIR_SPEED")
        self.particle_count = CanSatGraph("PARTICLE_COUNT")
